DROP TABLE IF EXISTS FLOWEDU_MEMBER;
CREATE TABLE FLOWEDU_MEMBER
    (
        ...
        member_type VARCHAR(10) NOT NULL COMMENT '운영자, 선생님인지 구분',
...
DROP TABLE IF EXISTS JOB_POSITION_INFO;
CREATE TABLE JOB_POSITION_INFO
    (
...
DROP TABLE IF EXISTS LECTURE_DETAIL_INFO;
CREATE TABLE LECTURE_DETAIL_INFO
    (
...
CREATE TABLE LECTURE_INFO
    (
        ...
        lecture_level VARCHAR(5) NOT NULL COMMENT '강의 레벨',
...
DROP TABLE IF EXISTS LECTURE_ROOM_INFO;
CREATE TABLE LECTURE_ROOM_INFO
    (
...
DROP TABLE IF EXISTS LECTURE_STUDENT_REL;
CREATE TABLE LECTURE_STUDENT_REL
    (
...
CREATE TABLE STUDENT
    (
        ...
        student_photo_file VARCHAR(45) COMMENT '학생 사진 파일명',
