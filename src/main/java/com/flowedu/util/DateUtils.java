...
public class DateUtils {
	...
	public static String addTime(String inputDate, int time) throws ParseException {
		...
		minusDate = dateFormat.format(cal.getTime());
		return minusDate;
	}

	public static String getMonth(String ymd, int monthCount) throws Exception {
		...
		String strMonth = dateFormat.format(calendar.getTime());
