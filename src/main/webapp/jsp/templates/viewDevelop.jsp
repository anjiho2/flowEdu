...
<body>
    ...
    <div style="border:solid 1px;width:700px;overflow: hidden;background: #fff;">
        <h2 style="border-bottom:solid 1px;width:100%;padding:20px 0 20px 20px;">플로우교육</h2>
        <div style="width:400px;margin:50px 150px;">
            ...
            <button style="background: #ccc;padding:10px 70px;"><a href="#">플로우교육 AMS 바로가기</a></button>
