...
<section class="content">
    ...
    <div class="tb_t1">
        <table class="table_width">
            ...
            <tr>
                <th>학원명<b>*</b></th>
                <td><input type="text" class="form-control" placeholder="수학의아침 초등관"></td>
                <th>원장명<b>*</b></th>
                <td><input type="text" class="form-control" placeholder="김기섭"></td>
            </tr>
            <tr>
                <th>전화번호<b>*</b></th>
                <td>
...
<div class="layer_popup_template apt_request_layer" id="" style="display: none;width: 450px;">
    ...
    <div class="layer-body">
        <div class="cont form_st1">
            <div class="form-group row">
                <label>이름</label>
                <div><input type="text" class="form-control" style="width: 140px;"></div>
            </div>
