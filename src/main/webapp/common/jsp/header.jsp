...
<div id="wrap">
    <header id="header">
        ...
        <nav id="lnb">
            ...
            <a href="javascript:goPage('academy', 'list_academy')"><span class="fa fa-university"></span>학원정보</a>
            <a href="javascript:goPage('member', 'list_member')"><span class="fa fa-address-card"></span>운영자/선생님정보</a>
