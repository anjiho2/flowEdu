...
<div id="wrap">
    <header id="header">
        ...
        <nav id="lnb" class="depth1">
            ...
            <a href="javascript:goPage('dashboard', 'dashboard_list')" <%=depth1 == 1 ? "class='on'" : ""%>>메인</a>
            <a href="javascript:goPage('student', 'save_student')" <%=depth1 == 2 ? "class='on'" : ""%>>학생관리</a>
             <a href="javascript:goPage('consult', 'early_consult_memo')" <%=depth1 == 3 ? "class='on'" : ""%>>학습관리</a>
            <a href="javascript:goPage('academy', 'list_academy')" <%=depth1 == 4 ? "class='on'" : ""%>>행정관리</a>
            <a href="javascript:goPage('member', 'list_member')" <%=depth1 == 5 ? "class='on'" : ""%>>경영관리</a>
            <a href="javascript:goPage('lecture', 'lecture_list')" <%=depth1 == 6 ? "class='on'" : ""%>>운영세팅관리</a>
            <a href="javascript:goPage('', '')" <%=depth1 == 7 ? "class='on'" : ""%>>커뮤니티관리</a>
            <a href="javascript:goPage('', '')" <%=depth1 == 8 ? "class='on'" : ""%>>ERP</a>
            <a href="javascript:goPage('', '')" <%=depth1 == 9 ? "class='on'" : ""%>>시스템관리</a>
            <a href="javascript:goPage('template', 'formType1')" <%=depth1 == 10 ? "class='on'" : ""%>>프론트 개발 페이지</a>
